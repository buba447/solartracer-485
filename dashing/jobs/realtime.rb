...
powerGen = ((`python /home/pi/coding/white_whale/jobs/getRegister.py 0x330C`).to_f * 100) / 12.0
powerUsed = ((`python /home/pi/coding/white_whale/jobs/getRegister.py 0x3304`).to_f * 100) / 12.0
